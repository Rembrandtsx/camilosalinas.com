...
const filenames = [
  "01_-_Waste_of_Time-Mø",
  "02_-_Walk_This_Way-Mø",
  "03_-_Final_Song-Mø",
  "04_-_Kamikaze-Mø",
  "05_-_When_I_Was_Young-Mø",
  "06_-_Despair_Hangover_And_Ecstasy-The_Dø",
  "07_-_Praf_De_Stele-Vita_De_Vie",
  "08_-_7th_Element-Vitas",
  "09_-_Conqueror-AURORA",
];
...
module.exports = function () {
  ...
  function queue() {
    ...
    lastTrackName = lastTrackName.trim();
